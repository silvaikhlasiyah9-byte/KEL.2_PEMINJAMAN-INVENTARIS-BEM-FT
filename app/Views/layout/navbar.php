<nav class="navbar navbar-dark navbar-top">
    <div class="container-fluid">
        <span class="navbar-brand fw-bold">INVENTARIS BEM FT UM</span>
...
<div class="container-fluid d-flex flex-column px-3 pt-0">
 ...
 <div class="container-fluid d-flex flex-column px-3 pt-0">
    ...
    <!-- JUDUL -->
    <div class="text-center mt-1 mb-1">
        <span class="fw-bold">BEM FT</span>
    </div>

    <!-- ICON MENU -->
    <button class="navbar-toggler mx-auto mb-2 p-1 border-0" type="button"
